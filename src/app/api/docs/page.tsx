        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl font-bold text-[#0a192f]" style={{ fontFamily: "'Playfair Display', serif" }}>API Documentation</h1>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-sm text-[#5a7a9a] leading-relaxed">
                The Student Blueprint API allows agencies to programmatically invite students, manage assessments, and retrieve results for integration into their own CRM or student portals.
              </p>
            </div>
            ...
            {API_DOCS.map((doc, i) => (
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h2 className="text-2xl font-bold text-[#0a192f]" style={{ fontFamily: "'Playfair Display', serif" }}>{doc.title}</h2>
