...
import { buildProcessPhase2Prompt } from '@/lib/assessment-prompts'
...
export async function POST(
  ...
  try {
    ...
    console.log(`[Phase2] Starting for assessment ${assessmentId} (type: ${assessment.student_type || 'high_school'})`)
