  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
          ...
          router.push(data.redirectUrl || "/partner")
      } else {
        ...
        >
            <div className="text-center mb-8">
              <Image
                ...
                />
                <h1 className="text-3xl tracking-tight" style={{ fontFamily: "'Montserrat', sans-serif" }}>
          ...
          >
            <Card className="border border-[#e5e0d5] bg-white">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-[#1e3a5f]">Referral Partner Portal</CardTitle>
                <CardDescription className="text-[#5a7a9a]">Sign in to access your partner dashboard</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <p className="text-center text-sm text-[#5a7a9a] mt-4">
                  New partner?{" "}
                  <Link href="/partner/setup-password" className="text-[#c9a227] hover:underline">
